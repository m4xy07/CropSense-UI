    ...
    return (
        <section className="pb-12 mb-20 pt-4 bg-dark">
            <div className="container mx-auto">
                ...
                <div
                    id="features"
                    className="relative mt-10 gap-4 sm:mt-8 h-[4500px] font-inter"
                >
                    {/* Real-time Farm Data */}
                    ...
                    <div className="detection-div">
                        ...
                        <div className="oobe-div-inner">
                            ...
                            <div className="real-time-content">
                                <div className="real-time-content-heading">
                                    Marketplace, Rentals, & Community
                                </div>
                                <div className="real-time-content-description">
                                    Farm equipment renting platform, product marketplace, and active forums to connect with fellow farmers and agricultural experts.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="guidance-div overflow-hidden">
                        <div className="guidance-div-inner">
                            ...
                            <div className="real-time-content">
                                ...
                                <div className="real-time-content-description">
                                Personalized agricultural guides based on your specific farm data—no generic advice, inlcluding government schemes and insurance, specific to your region and crops.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="analysis-div overflow-hidden">
                        <div className=" analysis-div-inner">
                            ...
                            <div className="real-time-content">
                                ...
                                <div className="real-time-content-description">
                                Say goodbye to annual soil tests—CropSense analyzes soil quality and nutrients automatically with just a tap.
                                </div>
                            </div>
                        </div>
                    </div>
