...
import { ThermometerSun, Sprout, Droplets, Droplet, Leaf, Download, Upload } from 'lucide-react';
import {
  RiArrowDownLine,
  RiArrowUpLine,
              ...
              <div className="flex flex-row gap-[1.25rem] magical-borders-content">
                  ...
                  <div className="flex flex-col p-5 pt-0 gap-4">
                    ...
                    <div className="bg-transparent flex flex-row gap-4">
                      <div className="bg-green-500/75 rounded-full p-[8px] h-fit w-fit flex items-start mb-3">
                        <Wheat className="inline-flex text-white size-4" aria-hidden="true" />
                      </div>
                      <div className="border-b border-zinc-50/10 w-full mt-1 pb-3 flex flex-row justify-between">
                        <p className="text-white text-[14px]">
                          ...
                          <span className="text-[#9CA3AF]">of projected yields for</span> rice{" "}
                          <span className="text-[#9CA3AF]">this season</span>
                        </p>
                    ...
                    <div className="bg-transparent flex flex-row gap-4">
                      <div className="bg-[rgba(255,86,86,.75)] rounded-full p-[8px] h-fit w-fit flex items-start mb-3">
                        <CircleAlert className="inline-flex text-white size-4" aria-hidden="true" />
                      </div>
                      <div className="border-b border-zinc-50/10 w-full mt-1 pb-3 flex flex-row justify-between">
                        <p className="text-white text-[14px]">
                          <span className="text-[#9CA3AF]">Early signs of</span> blight{" "}
                          <span className="text-[#9CA3AF]">detected on your</span> tomato{" "}
                          <span className="text-[#9CA3AF]">crop</span>
                        </p>
                        <p className="text-[#c0c4cc] font-normal text-[13px] tracking-tighter">
                          May 24, 2025
                        </p>
                    ...
                    <div className="bg-transparent flex flex-row gap-4">
                      <div className="bg-green-600/75 rounded-full p-[8px] h-fit w-fit flex items-start mb-3">
                        <ArrowRight className="inline-flex text-white size-4" aria-hidden="true" />
                      </div>
                      <div className="border-b border-zinc-50/10 w-full mt-1 pb-3 flex flex-row justify-between">
                        <p className="text-white text-[14px]">
                    ...
                    <div className="bg-transparent flex flex-row gap-4">
                      <div className="bg-[rgba(103,191,255,.75)] rounded-full p-[8px] h-fit w-fit flex items-start mb-3">
                        <CloudRainWind className="inline-flex text-white size-4" aria-hidden="true" />
                      </div>
                      <div className="border-b border-zinc-50/10 w-full mt-1 pb-3 flex flex-row justify-between">
                        <p className="text-white text-[14px]">
                          Light <span className="text-[#9CA3AF]">to</span> moderate showers
                          <span className="text-[#9CA3AF]"> expected in your area</span> tomorrow
                        </p>
                        <p className="text-[#c0c4cc] font-normal text-[13px] tracking-tighter">
                          May 24, 2025
                        </p>
                    ...
                    <div className="bg-transparent flex flex-row gap-4">
                      ...
                      <div className="w-full mt-1 flex flex-row justify-between">
                        <p className="text-white text-[14px]">
                          Market price<span className="text-[#9CA3AF]"> for </span>onions{" "}
                          <span className="text-[#9CA3AF]">currently</span> up ₹3{" "}
                ...
                <div className="technical-tracking relative overflow-hidden border-zinc-50/10 rounded-xl border">
                  <div className="technical-tracking-inner technical-tracking-borders-inner">
                    ...
                    <img src="/technical-tracking-light.png" className="technical-tracking-light" />
                    <div className="technical-tracking-circles-wrapper lazy-background-image-maskImage">
                      <div className="technical-tracking-circles">
                        {[
                          ...
                          { t: 1.3383720930232528, l: 1.3383720930232528, w: 97.3232558139535, h: 97.3232558139535, d: 3.6 },
                          { t: 2.6534883720930225, l: 2.6534883720930225, w: 94.69302325581396, h: 94.69302325581396, d: 3.5 },
                          { t: 3.945348837209302, l: 3.945348837209302, w: 92.1093023255814, h: 92.1093023255814, d: 3.4 },
                          { t: 5.213953488372091, l: 5.213953488372091, w: 89.57209302325582, h: 89.57209302325582, d: 3.3 },
                          { t: 6.4593023255813975, l: 6.4593023255813975, w: 87.0813953488372, h: 87.0813953488372, d: 3.2 },
                          { t: 7.6813953488372135, l: 7.6813953488372135, w: 84.63720930232557, h: 84.63720930232557, d: 3.1 },
                          { t: 8.88023255813954, l: 8.88023255813954, w: 82.23953488372092, h: 82.23953488372092, d: 3.0 },
                          { t: 10.055813953488375, l: 10.055813953488375, w: 79.88837209302325, h: 79.88837209302325, d: 2.9 },
                          { t: 11.20813953488372, l: 11.20813953488372, w: 77.58372093023256, h: 77.58372093023256, d: 2.8 },
                          { t: 12.337209302325583, l: 12.337209302325583, w: 75.32558139534883, h: 75.32558139534883, d: 2.7 },
                          { t: 13.443023255813955, l: 13.443023255813955, w: 73.11395348837209, h: 73.11395348837209, d: 2.6 },
                          { t: 14.525581395348837, l: 14.525581395348837, w: 70.94883720930233, h: 70.94883720930233, d: 2.5 },
                          { t: 15.584883720930236, l: 15.584883720930236, w: 68.83023255813953, h: 68.83023255813953, d: 2.4 },
                          { t: 16.620930232558138, l: 16.620930232558138, w: 66.75813953488372, h: 66.75813953488372, d: 2.3 },
                          { t: 17.633720930232556, l: 17.633720930232556, w: 64.73255813953489, h: 64.73255813953489, d: 2.2 },
                          { t: 18.62325581395349, l: 18.62325581395349, w: 62.75348837209302, h: 62.75348837209302, d: 2.1 },
                          { t: 19.589534883720933, l: 19.589534883720933, w: 60.82093023255813, h: 60.82093023255813, d: 2.0 },
                          { t: 20.532558139534885, l: 20.532558139534885, w: 58.93488372093023, h: 58.93488372093023, d: 1.9 },
                          { t: 21.45232558139535, l: 21.45232558139535, w: 57.0953488372093, h: 57.0953488372093, d: 1.8 },
                          { t: 22.348837209302328, l: 22.348837209302328, w: 55.302325581395344, h: 55.302325581395344, d: 1.7 },
                          { t: 23.222093023255816, l: 23.222093023255816, w: 53.55581395348837, h: 53.55581395348837, d: 1.6 },
                          { t: 24.072093023255817, l: 24.072093023255817, w: 51.855813953488365, h: 51.855813953488365, d: 1.5 },
                          { t: 24.89883720930233, l: 24.89883720930233, w: 50.20232558139534, h: 50.20232558139534, d: 1.4 },
                          { t: 25.70232558139535, l: 25.70232558139535, w: 48.5953488372093, h: 48.5953488372093, d: 1.3 },
                          { t: 26.482558139534884, l: 26.482558139534884, w: 47.03488372093023, h: 47.03488372093023, d: 1.2 },
                          { t: 27.23953488372093, l: 27.23953488372093, w: 45.52093023255814, h: 45.52093023255814, d: 1.1 },
                          { t: 27.973255813953486, l: 27.973255813953486, w: 44.05348837209303, h: 44.05348837209303, d: 1.0 },
                          { t: 28.683720930232557, l: 28.683720930232557, w: 42.632558139534886, h: 42.632558139534886, d: 0.9 },
                          { t: 29.370930232558145, l: 29.370930232558145, w: 41.25813953488371, h: 41.25813953488371, d: 0.8 },
                          { t: 30.034883720930235, l: 30.034883720930235, w: 39.93023255813953, h: 39.93023255813953, d: 0.7 },
                          { t: 30.67558139534884, l: 30.67558139534884, w: 38.64883720930232, h: 38.64883720930232, d: 0.6 },
                          { t: 31.293023255813956, l: 31.293023255813956, w: 37.41395348837209, h: 37.41395348837209, d: 0.5 },
                          { t: 31.887209302325584, l: 31.887209302325584, w: 36.22558139534883, h: 36.22558139534883, d: 0.4 },
                          { t: 32.45813953488372, l: 32.45813953488372, w: 35.08372093023256, h: 35.08372093023256, d: 0.3 },
                          { t: 33.00581395348837, l: 33.00581395348837, w: 33.98837209302326, h: 33.98837209302326, d: 0.2 },
                          { t: 33.53023255813954, l: 33.53023255813954, w: 32.939534883720924, h: 32.939534883720924, d: 0.1 },
                        ].map((circle, idx) => (
                          <div
                            key={idx}
                            style={{
