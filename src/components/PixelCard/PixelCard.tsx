...
export default function PixelCard({
    ...
    return (
        <div
            ref={containerRef}
            className={`h-[100px] w-[180px] relative overflow-hidden grid place-items-center aspect-[4/5] border border-[#20202286] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
