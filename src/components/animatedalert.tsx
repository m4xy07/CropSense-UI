        ...
        >
            <Alert className={cn(
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <div className={cn(
                            "p-2.5 relative w-12 h-12 rounded-full overflow-hidden shrink-0",
                           
                        )}>
                            <Image src="/avatar2.jpg" alt="User Avatar"
                  fill
                  ...
                  sizes="100px" />
                    ...
                    <div className="space-y-1">
                        ...
                        >
                            @{user?.firstName || user?.username || "Friend"} I need 20 bags of fertilizer for my farm. Can you help me out?
                        </motion.p>
                    </div>
                </div>
