        ...
        for (let i = 0; i < pathLength; i++) {
          animations.push(
            anime({
              ...
              stroke: {
                value: ["#0a1f44", "rgba(10, 31, 68, 0.35)"],
                duration: 700,
              },
              translateX: [2, -2],
              translateY: [2, -2],
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center">
      <div className="relative w-full h-full flex items-center justify-center">
        <div
          ref={sphereRef}
          className="absolute left-1/2 top-1/2 -ml-[20px] -mt-[180px] h-[45px] w-[45px]"
        >
          <svg
            className="sphere"
            viewBox="0 0 440 440"
            stroke="rgba(10, 31, 68, 1)"
            fill="none"
          >
            <defs>
              <linearGradient
            ...
            {/* Sphere Background */}
            <circle cx="220" cy="220" r="200" fill="url(#sphereGradient)" />

            {/* Original Paths (Underlay) */}
