  ...
  if (currentVal < idealVal) {
    return (
      <span className="inline-flex items-center gap-x-1 ml-1 text-[11px] font-normal text-red-500 bg-[#d104121f] rounded-[4px] px-1 py-0.5">
        {difference}
        <svg width="9" height="8" viewBox="0 0 9 8" fill="none" className="size-2" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M0.933058 0.683058C1.17714 0.438981 1.57286 0.438981 1.81694 0.683058L7 5.86612V2.375C7 2.02982 7.27982 1.75 7.625 1.75C7.97018 1.75 8.25 2.02982 8.25 2.375V7.375C8.25 7.72018 7.97018 8 7.625 8H2.625C2.27982 8 2 7.72018 2 7.375C2 7.02982 2.27982 6.75 2.625 6.75H6.11612L0.933058 1.56694C0.688981 1.32286 0.688981 0.927136 0.933058 0.683058Z" fill="#D10412"></path></svg>
      </span>
    );
  }
