    ...
    switch (currentStep) {
      ...
      case 1:
        if (formData.profession === "no") {
          return (
            ...
            formData.professionElaborate.trim() !== ""
          );
        }
      ...
      case 2:
        ...
        if (formData.irrigationSystem === "other") {
          return (
            formData.irrigationSystem.trim() !== "" &&
            formData.irrigationSystemElaborate.trim() !== "" &&
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <motion.div variants={fadeInUp} className="space-y-2">
                        <Label htmlFor="company">
                          What was the last crop you planted?
                        </Label>
                        <SearchDropComponent />
                      </motion.div>
                    </CardContent>
                    ...
                    <CardContent className="space-y-4">
                      <motion.div variants={fadeInUp} className="space-y-2">
                        <Label htmlFor="profession">
                          Are you currently growing any crops?
                        </Label>
                        <RadioGroup
                    ...
                    <CardContent className="space-y-4">
                      <motion.div variants={fadeInUp} className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            updateFormData("irrigationSystem", value)
                          }
                        >
                          <SelectTrigger
                            id="irrigationSystem"
                      ...
                      <motion.div variants={fadeInUp} className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="increaseYield">
                              Increase yield
                            </SelectItem>
                            <SelectItem value="saveWater">
                              Save water
                            </SelectItem>
                            <SelectItem value="pestAlerts">
                              Get pest alerts
                            </SelectItem>
                            <SelectItem value="soilHealth">
                              Monitor soil health
                            </SelectItem>
                            <SelectItem value="govtSchemes">
                              Access government schemes
                            </SelectItem>
                            <SelectItem value="weatherWarnings">
