...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "main-dashboard-theme theme-color text-white flex size-full flex-col overflow-hidden rounded-xl",
        className
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div
      className=" flex items-center border-b border-zinc-50/10 py-2 px-5"
      cmdk-input-wrapper=""
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "placeholder:text-muted-foreground/70 flex h-10 w-full rounded-md bg-transparent !px-3 py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50 equipment-input theme-color",
          className
        )}
        {...props}
      />
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "data-[selected=true]:bg-[rgba(255,255,255,0.05)] data-[selected=true]:text-white !hover:bg-[rgba(255,255,255,0.05)] text-white relative flex cursor-default items-center gap-3 rounded-md px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    />
